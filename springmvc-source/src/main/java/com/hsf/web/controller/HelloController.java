package com.hsf.web.controller;
...
import com.hsf.web.model.ModelResult;
import com.hsf.web.service.HelloService;
...
//		}
	...
	public ModelResult modelResult(String code, HttpServletResponse response) throws Exception {

		ModelResult modelResult = new ModelResult();
		modelResult.setCode(code);
		final ObjectMapper objectMapper = new ObjectMapper();
//		response.getWriter().write(objectMapper.writeValueAsString(modelResult));
		return modelResult;
	}
